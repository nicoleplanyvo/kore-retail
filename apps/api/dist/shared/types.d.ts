...
export interface FRSession {
    id: string;
    storeId: string;
    roomId: string;
    staffId: string | null;
    status: FRSessionStatus;
    itemsIn: number;
    itemsReturned: number | null;
    itemsPurchased: number | null;
    itemsShrinkage: number | null;
    conversionRate: number | null;
    notes: string | null;
    checkInAt: string;
...
export interface StockCallout {
    ...
    reorderPoint: number;
    requestedQty: number;
    urgency: StockCalloutUrgency;
    status: StockCalloutStatus;
    reportedBy: string;
}
