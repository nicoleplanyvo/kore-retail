 ...
 */
export function createToolUpload(toolSlug) {
...
export function getUploadPath(relativePath) {
    return path.join(UPLOAD_DIR, relativePath);
}
/** Gibt den relativen Pfad für die Datenbank zurück */
export function getRelativePath(toolSlug, tenantId, sessionId, filename) {
