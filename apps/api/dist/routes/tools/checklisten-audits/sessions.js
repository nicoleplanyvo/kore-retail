...
export const caSessionsRouter = Router();
// ── Zod Schemas ──────────────────────────────────────
...
// ── POST /sessions ───────────────────────────────────
caSessionsRouter.post('/', requireMinRole('store_manager'), async (req, res) => {
    try {
...
caSessionsRouter.post('/:id/complete', requireMinRole('store_manager'), async (req, res) => {
    try {
        const tenantId = req.tenantId;
        const sessionId = req.params['id'];
        const session = await prisma.auditSession.findUnique({
...
caSessionsRouter.post('/:id/cancel', requireMinRole('store_manager'), async (req, res) => {
    try {
        const tenantId = req.tenantId;
        const sessionId = req.params['id'];
...
caSessionsRouter.put('/:id/responses/:criterionId', requireMinRole('store_manager'), async (req, res) => {
    try {
