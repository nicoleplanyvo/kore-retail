...
export const checklistenTemplatesRouter = Router();
...
checklistenTemplatesRouter.post('/', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
...
checklistenTemplatesRouter.put('/:id', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
...
checklistenTemplatesRouter.post('/:id/clone', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
        const tenantId = req.tenantId;
        const userId = req.user.sub;
