...
export const seaTemplatesRouter = Router();
...
seaTemplatesRouter.post('/', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
...
seaTemplatesRouter.put('/:id', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
...
seaTemplatesRouter.delete('/:id', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
        const tenantId = req.tenantId;
        const templateId = req.params['id'];
        const existing = await prisma.auditTemplate.findUnique({
...
seaTemplatesRouter.post('/:id/clone', requireRole('tenant_admin', 'kore_admin'), async (req, res) => {
    try {
        const tenantId = req.tenantId;
        const userId = req.user.sub;
