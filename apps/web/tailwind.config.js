  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        h2: ['1.8rem', { lineHeight: '1.2', fontWeight: '300' }],
        h3: ['1.45rem', { lineHeight: '1.3', fontWeight: '600' }],
        lead: ['1.25rem', { lineHeight: '1.6', fontWeight: '300' }],
        body: ['0.9rem', { lineHeight: '1.8', fontWeight: '300' }],
        small: ['0.82rem', { lineHeight: '1.5', fontWeight: '300' }],
        caption: ['0.65rem', { lineHeight: '1.5', fontWeight: '500', letterSpacing: '0.16em' }],
      },
      borderRadius: {
        sm: '2px',
        md: '4px',
