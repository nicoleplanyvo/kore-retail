  ...
  return (
    <div className="p-xl max-w-5xl">
      <div className="flex items-center gap-md mb-2xl">
        <Link to="/app/tools/maintenance" className="text-kore-mid hover:text-kore-ink transition-colors"><ArrowLeft size={20} /></Link>
        <div>
      ...
      {isLoading ? (
        ...
        <>
          <div className="space-y-md">
            {requests.map((r: any) => (
              <Link key={r.id} to={`/app/tools/maintenance/requests/${r.id}`} className="block bg-kore-white border border-kore-border p-lg hover:border-kore-brass transition-colors">
