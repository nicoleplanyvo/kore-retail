...
export function SessionListPage() {
  ...
  return (
    <div className="p-xl max-w-5xl">
      <Breadcrumb items={[{ label: 'Checklisten', href: '/app/tools/checklisten' }, { label: 'Sessions' }]} />
      <Link
        to="/app/tools/checklisten"
      ...
      <div className="flex items-center justify-between mb-2xl">
        ...
        <Link
          to="/app/tools/checklisten/sessions/new"
                        ...
                        <Link
                          to={
                            session.status === 'IN_PROGRESS'
                              ? `/app/tools/checklisten/sessions/${session.id}/conduct`
                              : `/app/tools/checklisten/sessions/${session.id}`
                          }
