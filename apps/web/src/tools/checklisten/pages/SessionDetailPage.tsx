...
export function SessionDetailPage() {
  ...
  return (
    <div className="p-xl max-w-4xl">
      <Breadcrumb items={[{ label: 'Checklisten', href: '/app/tools/checklisten' }, { label: 'Sessions', href: '/app/tools/checklisten/sessions' }, { label: 'Details' }]} />
      <Link
        to="/app/tools/checklisten/sessions"
