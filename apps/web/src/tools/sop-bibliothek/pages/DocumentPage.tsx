...
export function DocumentPage() {
  ...
  return (
    <div className="p-xl max-w-4xl">
      <Link to="/app/tools/sop" className="flex items-center gap-sm text-small text-kore-mid hover:text-kore-ink mb-xl"><ArrowLeft size={16} /> Zurück zur Bibliothek</Link>
        ...
        <div className="p-xl border-b border-kore-border">
          <div className="flex items-start justify-between gap-lg">
            ...
            <div className="flex items-center gap-md flex-shrink-0">
              <button onClick={() => navigate(`/app/tools/sop/documents/${id}/edit`)} className="flex items-center gap-sm border border-kore-border text-kore-ink px-md py-sm text-small hover:bg-kore-bg transition-colors"><Edit size={14} /> Bearbeiten</button>
            </div>
          </div>
        </div>
